                ...
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    ...
                    <div class="social-links flex space-x-4">
                        ...
                        foreach ($social_links as $platform => $url) :
                            if (!empty($url)) :
                                ?>
                                <a href="<?php echo esc_url($url); ?>" class="text-gray-400 hover:text-white transition-colors" aria-label="<?php echo esc_attr(ucfirst($platform)); ?>" target="_blank" rel="noopener noreferrer">
