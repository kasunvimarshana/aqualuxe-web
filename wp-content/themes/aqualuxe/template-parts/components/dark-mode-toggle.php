<?php
/**
 * Template part for displaying dark mode toggle
 *
 * @package AquaLuxe
 */
...
<div class="dark-mode-toggle">
    <button 
        id="dark-mode-toggle" 
        class="dark-mode-button p-2 text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" 
