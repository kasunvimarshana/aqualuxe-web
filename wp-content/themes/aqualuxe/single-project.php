        ...
        <div class="container mx-auto px-4">
            ...
            ?>
                <article id="post-<?php the_ID(); ?>" <?php post_class('bg-white shadow-lg rounded-lg overflow-hidden'); ?>>
                    ...
                    <footer class="entry-footer p-8 bg-gray-50">
                        <?php
                        // You can add more details here, like project date, client name, etc.
                        // Example:
                        // if (get_post_meta(get_the_ID(), '_project_client', true)) {
                        //     echo '<strong>Client:</strong> ' . esc_html(get_post_meta(get_the_ID(), '_project_client', true));
                        // }
                        ?>
                    </footer><!-- .entry-footer -->
