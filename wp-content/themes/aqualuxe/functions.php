...
/**
 * Load critical fixes and security enhancements
 */
if (file_exists(AQUALUXE_INCLUDES_DIR . '/class-critical-fixes.php')) {
    require_once AQUALUXE_INCLUDES_DIR . '/class-critical-fixes.php';
}
if (file_exists(AQUALUXE_INCLUDES_DIR . '/class-security-enhancements.php')) {
    require_once AQUALUXE_INCLUDES_DIR . '/class-security-enhancements.php';
}

/**
 * Load modules
 */
require_once AQUALUXE_MODULES_DIR . '/class-module-loader.php';
