...
function enterprise_theme_init_services() {
    ...
    // Load AquaLuxe business modules
    $aqualuxe_modules = array(
        'inc/modules/class-aqualuxe-business-module.php',
        'inc/ajax/class-aqualuxe-business-ajax.php',
    );
    ...
    // Load AquaLuxe business modules
    foreach ($aqualuxe_modules as $module) {
        $module_path = ENTERPRISE_THEME_PATH . '/' . $module;
    ...
    // Initialize AquaLuxe business module
    if (class_exists('AquaLuxe_Business_Module')) {
...
function enterprise_theme_scripts() {
    ...
    // AquaLuxe Business CSS
    wp_enqueue_style(
        'aqualuxe-business-style',
        ENTERPRISE_THEME_URL . '/assets/css/aqualuxe-business.css',
        array('enterprise-theme-style'),
        ENTERPRISE_THEME_VERSION
    );
    ...
    // AquaLuxe Business JavaScript
    wp_enqueue_script(
        'aqualuxe-business-js',
        ENTERPRISE_THEME_URL . '/assets/js/aqualuxe-business.js',
        array('jquery', 'enterprise-theme-js'),
        ENTERPRISE_THEME_VERSION,
        true
    );
    ...
    // AquaLuxe Business AJAX data
    wp_localize_script('aqualuxe-business-js', 'aqualuxe_ajax', array(
        'ajax_url' => admin_url('admin-ajax.php'),
        'nonce'    => wp_create_nonce('aqualuxe_ajax_nonce'),
        'strings'  => array(
            'loading'      => esc_html__('Loading...', ENTERPRISE_THEME_TEXTDOMAIN),
            'error'        => esc_html__('Error occurred', ENTERPRISE_THEME_TEXTDOMAIN),
            'success'      => esc_html__('Success!', ENTERPRISE_THEME_TEXTDOMAIN),
            'confirm'      => esc_html__('Are you sure?', ENTERPRISE_THEME_TEXTDOMAIN),
            'booking_success' => esc_html__('Service booked successfully!', ENTERPRISE_THEME_TEXTDOMAIN),
            'trade_created'   => esc_html__('Trade request created!', ENTERPRISE_THEME_TEXTDOMAIN),
        )
    ));
}
