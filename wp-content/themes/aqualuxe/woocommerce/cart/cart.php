...
if (function_exists('do_action')) { call_user_func('do_action', 'woocommerce_before_cart'); }
...
if (function_exists('do_action')) { call_user_func('do_action', 'woocommerce_after_cart'); }
