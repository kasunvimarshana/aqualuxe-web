...
class AquaLuxe_Assets
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style(
            'aqualuxe-style',
            AQUALUXE_URI . '/style.css',
            array('storefront-style'),
            AQUALUXE_VERSION
        );

        // Enqueue Fish Species styles
        if (is_singular('fish_species') || is_post_type_archive('fish_species') || is_tax('fish_category') || is_tax('care_level')) {
            wp_enqueue_style(
        ...
        if (is_page('water-parameter-calculator') || is_page('tank-volume-calculator') || is_page('fish-stocking-calculator')) {
            wp_enqueue_style(
                'aqualuxe-calculator',
        ...
        if (is_page('fish-compatibility-checker') || is_singular('fish_species')) {
            wp_enqueue_style(
