...
<div class="cart-container">
                ...
                <tr>
                    <td colspan="6" class="actions">
                        ...
                        <div class="cart-actions">
                            <a href="<?php echo esc_url(apply_filters('woocommerce_return_to_shop_redirect', wc_get_page_permalink('shop'))); ?>" class="button button-outline continue-shopping">
    ...
    <?php if (get_theme_mod('woocommerce_cart_features', true)) : ?>
        <div class="cart-features">
            <?php
            $features = get_theme_mod('woocommerce_cart_features_content', '');
