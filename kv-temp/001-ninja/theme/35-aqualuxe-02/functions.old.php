...
function aqualuxe_scripts() {
    ...
    // Add main stylesheet.
    wp_enqueue_style( 'aqualuxe-main', AQUALUXE_THEME_URI . 'assets/dist/css/main' . $suffix . '.css', array(), AQUALUXE_VERSION );

    // Add print stylesheet.
    wp_enqueue_style( 'aqualuxe-print', AQUALUXE_THEME_URI . 'assets/dist/css/print' . $suffix . '.css', array(), AQUALUXE_VERSION, 'print' );
    
    // Enqueue page template styles if needed
    if ( is_page_template( 'page-templates/portfolio.php' ) || is_page_template( 'page-templates/blog-grid.php' ) || is_page_template( 'page-templates/contact.php' ) || is_page_template( 'page-templates/full-width.php' ) || is_page_template( 'page-templates/landing-page.php' ) ) {
        wp_enqueue_style( 'aqualuxe-page-templates', AQUALUXE_THEME_URI . 'assets/dist/css/page-templates' . $suffix . '.css', array( 'aqualuxe-main' ), AQUALUXE_VERSION );
    }

    // Enqueue WooCommerce styles if active
    if ( class_exists( 'WooCommerce' ) && ( is_woocommerce() || is_cart() || is_checkout() || is_account_page() ) ) {
        wp_enqueue_style( 'aqualuxe-woocommerce', AQUALUXE_THEME_URI . 'assets/dist/css/woocommerce' . $suffix . '.css', array( 'aqualuxe-main' ), AQUALUXE_VERSION );
    }

    // Enqueue block styles
    wp_enqueue_style( 'aqualuxe-block-styles', AQUALUXE_THEME_URI . 'assets/dist/css/block-styles' . $suffix . '.css', array( 'aqualuxe-main' ), AQUALUXE_VERSION );

    // Enqueue scripts.
    wp_enqueue_script( 'aqualuxe-navigation', AQUALUXE_THEME_URI . 'assets/dist/js/navigation' . $suffix . '.js', array(), AQUALUXE_VERSION, true );
    wp_enqueue_script( 'aqualuxe-main', AQUALUXE_THEME_URI . 'assets/dist/js/main' . $suffix . '.js', array( 'jquery' ), AQUALUXE_VERSION, true );
    wp_enqueue_script( 'aqualuxe-lazy-loading', AQUALUXE_THEME_URI . 'assets/dist/js/lazy-loading' . $suffix . '.js', array( 'jquery' ), AQUALUXE_VERSION, true );

    // Enqueue WooCommerce scripts if active
    if ( class_exists( 'WooCommerce' ) && ( is_woocommerce() || is_cart() || is_checkout() || is_account_page() ) ) {
        wp_enqueue_script( 'aqualuxe-woocommerce', AQUALUXE_THEME_URI . 'assets/dist/js/woocommerce' . $suffix . '.js', array( 'jquery' ), AQUALUXE_VERSION, true );
    ...
    wp_localize_script(
        ...
        array(
            'ajaxUrl'    => admin_url( 'admin-ajax.php' ),
            'nonce'      => wp_create_nonce( 'aqualuxe-load-more' ),
...
function aqualuxe_block_editor_assets() {
    ...
    // Enqueue editor styles
    wp_enqueue_style( 'aqualuxe-editor-style', AQUALUXE_THEME_URI . 'assets/dist/css/editor-style' . $suffix . '.css', array(), AQUALUXE_VERSION );
    
    // Enqueue block editor script
    wp_enqueue_script( 'aqualuxe-block-editor', AQUALUXE_THEME_URI . 'assets/dist/js/block-editor' . $suffix . '.js', array( 'wp-blocks', 'wp-dom', 'wp-edit-post' ), AQUALUXE_VERSION, true );
}
 ...
 * Customizer Controls.
 */
require AQUALUXE_THEME_DIR . 'inc/customizer/controls/class-aqualuxe-toggle-control.php';
require AQUALUXE_THEME_DIR . 'inc/customizer/controls/class-aqualuxe-radio-image-control.php';
require AQUALUXE_THEME_DIR . 'inc/customizer/controls/class-aqualuxe-range-control.php';
require AQUALUXE_THEME_DIR . 'inc/customizer/controls/class-aqualuxe-color-alpha-control.php';
 ...
 * Asset Management.
 */
require AQUALUXE_THEME_DIR . 'inc/class-aqualuxe-assets.php';

/**
 * Gutenberg Compatibility.
 */
require AQUALUXE_THEME_DIR . 'inc/class-aqualuxe-gutenberg.php';

/**
 * WooCommerce Integration.
 */
if ( class_exists( 'WooCommerce' ) ) {
    require AQUALUXE_THEME_DIR . 'inc/class-aqualuxe-woocommerce.php';
