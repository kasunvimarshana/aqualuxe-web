...
<div id="comments" class="comments-area mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
    ...
    if (have_comments()) :
        ...
        if (!comments_open()) :
            ?>
            <p class="no-comments bg-yellow-50 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 p-4 rounded-md mt-6"><?php esc_html_e('Comments are closed.', 'aqualuxe'); ?></p>
            <?php
        endif;
    ...
    comment_form([
        'class_form' => 'comment-form bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm',
        'title_reply' => '<span class="text-2xl font-bold">' . esc_html__('Leave a Comment', 'aqualuxe') . '</span>',
