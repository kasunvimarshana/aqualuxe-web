...
(function($) {
  ...
  if (typeof aqualuxeData === 'undefined' || aqualuxeData.isWooCommerceActive !== 'yes') {
    // If WooCommerce is not active, don't initialize any WooCommerce-specific functionality
    console.log('WooCommerce is not active. WooCommerce-specific functionality will not be initialized.');
    return;
  }
