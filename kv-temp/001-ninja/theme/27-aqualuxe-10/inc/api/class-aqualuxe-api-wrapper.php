...
class AquaLuxe_API_Wrapper {
    ...
    public function __construct() {
        // First, load the main API class
        require_once AQUALUXE_DIR . 'inc/api/class-aqualuxe-api.php';
        
        // Then load the base controller class
        require_once AQUALUXE_DIR . 'inc/api/class-aqualuxe-api-controller.php';
