...
<section class="no-results not-found bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 transition-colors duration-300">
    <header class="page-header mb-6">
        <h1 class="page-title text-2xl font-bold text-gray-900 dark:text-white"><?php esc_html_e('Nothing Found', 'aqualuxe'); ?></h1>
    </header><!-- .page-header -->
