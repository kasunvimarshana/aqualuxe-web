...
<article id="post-<?php the_ID(); ?>" <?php post_class('bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-colors duration-300'); ?>>
    ...
    <div class="entry-content p-6">
        <header class="entry-header mb-4">
            ...
            if (is_singular()) :
                ...
                the_title('<h2 class="entry-title text-xl font-bold text-gray-900 dark:text-white mb-2"><a href="' . esc_url(get_permalink()) . '" rel="bookmark" class="hover:text-primary dark:hover:text-primary-dark transition-colors duration-300">', '</a></h2>');
            endif;
    ...
    <footer class="entry-footer px-6 pb-6 text-sm text-gray-600 dark:text-gray-400">
