...
/**
 * AquaLuxe Template Functions Class
 */
class AquaLuxe_Template_Functions {
    ...
    public function __construct() {
        ...
        add_action('after_setup_theme', array($this, 'register_template_functions'));
    }
    ...
    public function register_template_functions() {
        ...
        if (!function_exists('aqualuxe_excerpt_more')) {
            ...
            function aqualuxe_excerpt_more($link) {
                ...
                $link = sprintf(
                    '<p class="link-more"><a href="%1$s" class="more-link text-primary dark:text-primary-dark hover:underline transition-colors duration-300">%2$s</a></p>',
