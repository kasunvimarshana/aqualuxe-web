...
<?php else : ?>
	<div class="woocommerce-message woocommerce-message--info woocommerce-Message woocommerce-Message--info woocommerce-info">
		<div class="woocommerce-empty-state">
			...
			<h3 class="woocommerce-empty-state__title"><?php esc_html_e( 'No order has been made yet.', 'woocommerce' ); ?></h3>
			<p class="woocommerce-empty-state__description"><?php esc_html_e( 'When you place your first order, it will appear here.', 'aqualuxe' ); ?></p>
