...
function aqualuxe_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'aqualuxe_content_width', 640 );
}
...
function aqualuxe_scripts() {
	...
	wp_enqueue_script( 'aqualuxe-navigation', get_template_directory_uri() . '/js/navigation.js', array(), AQUALUXE_VERSION, true );
