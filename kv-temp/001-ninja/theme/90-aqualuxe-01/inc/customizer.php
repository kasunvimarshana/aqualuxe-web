<?php
/**
 * AquaLuxe Customizer functionality
 *
 * @package AquaLuxe
 */
...
function aqualuxe_customize_preview_js() {
	wp_enqueue_script( 'aqualuxe-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), AQUALUXE_VERSION, true );
}
