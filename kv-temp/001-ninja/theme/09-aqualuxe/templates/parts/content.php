...
<article id="post-<?php the_ID(); ?>" <?php post_class('mb-12'); ?>>
    ...
    <div class="entry-content prose max-w-none">
        ...
        if (is_singular()) :
            ...
            ?>
            <div class="mt-4">
                <a href="<?php echo esc_url(get_permalink()); ?>" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded transition duration-300">
