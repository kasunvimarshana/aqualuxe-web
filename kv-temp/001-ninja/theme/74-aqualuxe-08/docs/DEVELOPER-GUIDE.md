...
## Customizer-driven theming
- Primary color and body font are injected as inline CSS variables/classes at runtime.
- No rebuild required after changing Customizer settings.

## Editor styles
- The block editor enqueues the front CSS (`assets/dist/css/app.css`) and the same inline variables for WYSIWYG consistency.
