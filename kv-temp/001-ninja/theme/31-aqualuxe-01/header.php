...
<head>
    ...
    <?php aqualuxe_dark_mode_early_detection(); ?>
</head>
...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header" role="banner">
		<div class="container mx-auto px-4">
			<div class="flex items-center justify-between py-4">
				<div class="site-branding flex items-center">
					...
					?>
						<h1 class="site-title">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="text-2xl font-serif font-bold text-dark-800 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200">
								<?php bloginfo( 'name' ); ?>
							</a>
						</h1>
					<?php endif; ?>
				...
				<nav id="site-navigation" class="main-navigation hidden lg:flex" role="navigation" aria-label="<?php esc_attr_e( 'Primary Navigation', 'aqualuxe' ); ?>">
					...
					<div class="flex items-center ml-6 space-x-4">
						...
						<button id="dark-mode-toggle" class="dark-mode-toggle" role="switch" aria-checked="false" aria-label="<?php esc_attr_e( 'Toggle dark mode', 'aqualuxe' ); ?>">
				...
				<button id="mobile-menu-toggle" class="lg:hidden text-dark-700 dark:text-white" aria-controls="mobile-menu" aria-expanded="false" aria-label="<?php esc_attr_e( 'Toggle mobile menu', 'aqualuxe' ); ?>">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
		...
		<!-- Mobile Menu -->
		<div id="mobile-menu" class="lg:hidden bg-white dark:bg-dark-800 border-t border-gray-200 dark:border-dark-700" role="navigation" aria-label="<?php esc_attr_e( 'Mobile Navigation', 'aqualuxe' ); ?>" hidden>
			<?php
			wp_nav_menu(
				array(
		...
		<div id="search-overlay" class="fixed inset-0 bg-dark-900 bg-opacity-80 z-50 hidden" role="dialog" aria-modal="true" aria-labelledby="search-title">
			<div class="container mx-auto px-4 h-full flex items-center justify-center">
				<div class="bg-white dark:bg-dark-800 p-8 rounded-lg w-full max-w-2xl">
					<div class="flex justify-between items-center mb-6">
						<h2 id="search-title" class="text-2xl font-serif"><?php esc_html_e( 'Search', 'aqualuxe' ); ?></h2>
