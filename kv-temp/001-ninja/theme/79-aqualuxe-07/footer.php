    ...
    <div>
      ...
      <?php if (! has_nav_menu('footer')): ?>
        <ul class="space-y-1 text-sm mt-2">
          <li><a href="<?php echo esc_url( get_permalink( get_page_by_path('wholesale-b2b') ) ); ?>"><?php esc_html_e('Wholesale & B2B', 'aqualuxe'); ?></a></li>
          <li><a href="<?php echo esc_url( get_permalink( get_page_by_path('buy-sell-trade') ) ); ?>"><?php esc_html_e('Buy, Sell & Trade', 'aqualuxe'); ?></a></li>
          <li><a href="<?php echo esc_url( get_permalink( get_page_by_path('export') ) ); ?>"><?php esc_html_e('Export', 'aqualuxe'); ?></a></li>
        </ul>
      <?php endif; ?>
