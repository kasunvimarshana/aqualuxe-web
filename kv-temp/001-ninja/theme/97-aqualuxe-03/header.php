...
<div id="page" class="site min-h-screen flex flex-col">
		...
		<div class="container mx-auto px-4">
			<div class="flex justify-between items-center py-4">
				...
				<div class="flex items-center space-x-2">
                    ...
                    ?>
					<button id="dark-mode-toggle" data-dark-toggle aria-pressed="false" class="p-2 rounded-full text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
					...
					<button id="mobile-menu-button" data-nav-toggle class="md:hidden p-2 rounded-md text-gray-600 dark:text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
	...
	<div id="mobile-menu" data-nav-menu aria-hidden="true" class="md:hidden hidden">
