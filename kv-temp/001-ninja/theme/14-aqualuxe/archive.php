...
<main id="primary" class="site-main container mx-auto px-4 py-8">
    ...
    <?php if (have_posts()) : ?>
        ...
        <header class="page-header mb-8">
            <?php
            the_archive_title('<h1 class="page-title text-3xl font-bold text-primary dark:text-primary-dark">', '</h1>');
            the_archive_description('<div class="archive-description mt-4 text-gray-600 dark:text-gray-400">', '</div>');
            ?>
        </header><!-- .page-header -->
