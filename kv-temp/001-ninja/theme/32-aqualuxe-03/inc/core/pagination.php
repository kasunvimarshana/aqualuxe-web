...
/**
 * Display enhanced pagination for archive pages
 * This is an improved version with better styling and accessibility
 */
function aqualuxe_enhanced_pagination() {
    global $wp_query;
...
/**
 * Display post categories without wrapper
 * This is a simplified version that just outputs the category links
 */
function aqualuxe_post_categories_links() {
...
/**
 * Display post tags without wrapper
 * This is a simplified version that just outputs the tag links
 */
function aqualuxe_post_tags_links() {
