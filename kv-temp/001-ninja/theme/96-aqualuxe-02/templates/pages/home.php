...
<div class="home-page">
	...
	<section class="py-20 text-center text-white bg-blue-800 cta-section">
		<div class="container mx-auto">
			<h2 class="mb-4 text-4xl font-bold">Ready to Dive In?</h2>
			<p class="mb-8 text-xl">Browse our curated collection of aquatic wonders and bring the ocean home.</p>
			<a href="<?php echo esc_url( get_permalink( get_page_by_path( 'shop' ) ) ); ?>" class="px-8 py-3 font-bold text-blue-800 bg-white rounded-full hover:bg-gray-200">
				Shop Now
			</a>
		</div>
	</section>
