...
<main id="primary" class="site-main">
    <div class="container">
        ...
        <div class="page-header">
            ...
            if ( empty( $subtitle ) ) {
                $subtitle = __( 'How we collect, use, and protect your information', 'aqualuxe' );
            }
            ?>
                ...
                <ol class="toc-list">
                    ...
                    if ( ! empty( $matches ) ) {
                        ...
                        $default_sections = array(
                            __( 'Introduction', 'aqualuxe' ),
                            __( 'Information We Collect', 'aqualuxe' ),
                            __( 'How We Use Your Information', 'aqualuxe' ),
                            __( 'Information Sharing', 'aqualuxe' ),
                            __( 'Cookies and Tracking Technologies', 'aqualuxe' ),
                            __( 'Your Rights and Choices', 'aqualuxe' ),
                            __( 'Data Security', 'aqualuxe' ),
                            __( 'Children\'s Privacy', 'aqualuxe' ),
                            __( 'Changes to This Policy', 'aqualuxe' ),
                            __( 'Contact Us', 'aqualuxe' ),
                        );
        ...
        <div class="legal-contact">
            <h2><?php esc_html_e( 'Questions About Our Privacy Policy?', 'aqualuxe' ); ?></h2>
            <p><?php esc_html_e( 'If you have any questions or concerns about our privacy practices, please contact us.', 'aqualuxe' ); ?></p>
