                    ...
                    if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                        ...
                        <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                            ...
                            <td class="product-name" data-title="<?php esc_attr_e( 'Product', 'aqualuxe' ); ?>">
                                ...
                                // Display SKU
                                if ( $_product->get_sku() ) {
                                    echo '<div class="product-sku">' . esc_html__( 'SKU:', 'aqualuxe' ) . ' ' . esc_html( $_product->get_sku() ) . '</div>';
                                }
                                ?>
                            </td>
        ...
        <div class="cart-shipping-info">
            <div class="shipping-info-item">
                ...
                <div class="info-content">
                    ...
                    <p><?php esc_html_e( 'On orders over $100', 'aqualuxe' ); ?></p>
                </div>
            </div>
            <div class="shipping-info-item">
                ...
                <div class="info-content">
                    ...
                    <p><?php esc_html_e( 'For all fish and aquatic life', 'aqualuxe' ); ?></p>
                </div>
            </div>
            <div class="shipping-info-item">
                <i class="fas fa-undo-alt"></i>
                <div class="info-content">
                    <h4><?php esc_html_e( '30-Day Returns', 'aqualuxe' ); ?></h4>
                    <p><?php esc_html_e( 'For non-living products', 'aqualuxe' ); ?></p>
                </div>
            </div>
        </div>
    </div>
