 ...
 */
function aqualuxe_add_wholesale_roles() {
 ...
 */
function aqualuxe_handle_wholesale_application() {
    // Verify nonce
    ...
    // Basic validation
    $required_fields = array( 'company_name', 'contact_name', 'user_email' );
...
add_action( 'admin_post_nopriv_wholesale_application', 'aqualuxe_handle_wholesale_application' );
add_action( 'admin_post_wholesale_application', 'aqualuxe_handle_wholesale_application' );
