...
function aqualuxe_widgets_init() {
    ...
    register_sidebar(array(
        'name' => esc_html__('Top Bar Left', 'aqualuxe'),
        'id' => 'top-bar-left',
        'description' => esc_html__('Add widgets here to appear in the left side of the top bar.', 'aqualuxe'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
    ...
    register_sidebar(array(
        'name' => esc_html__('Top Bar Right', 'aqualuxe'),
        'id' => 'top-bar-right',
        'description' => esc_html__('Add widgets here to appear in the right side of the top bar.', 'aqualuxe'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3 class="widget-title screen-reader-text">',
        'after_title' => '</h3>',
...
require AQUALUXE_INC_DIR . 'dark-mode.php'; // Include dark mode functionality
...
/**
 * Add action hooks for theme components
 */
function aqualuxe_add_action_hooks() {
    // Add action hooks for header components
    add_action('aqualuxe_top_bar_right', 'aqualuxe_social_icons', 10);
    add_action('aqualuxe_header_actions', 'aqualuxe_header_search', 10);
    add_action('aqualuxe_footer_copyright', 'aqualuxe_footer_info', 10);
}
add_action('after_setup_theme', 'aqualuxe_add_action_hooks');