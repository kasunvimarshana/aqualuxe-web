...
## Modules included
- darkmode, multilingual, multicurrency, services, events, bookings, subscriptions, wholesale, auctions, tradeins, affiliates, sustainability, franchise, vendors, contact, filters, wishlist.

## Shop Filters
- Filters UI is embedded by default on the Shop page.
- Shortcode: `[aqualuxe_filters]` (category + min/max price) — server-side query is applied automatically.
