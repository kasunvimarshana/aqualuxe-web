...
final class AssetsModule {
    ...
    $editorCss = function_exists('aqlx_asset') ? aqlx_asset('css/editor.css') : ( get_template_directory_uri() . '/assets/dist/css/editor.css' );
    \wp_enqueue_style( 'aqualuxe-editor', $editorCss, [], AQUALUXE_VERSION );
    }
}
