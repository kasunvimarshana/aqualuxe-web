...
final class Modules {
    ...
    'woo' => \Aqualuxe\Modules\Woo\WooModule::class,
    'dark_mode' => \Aqualuxe\Modules\UI\DarkModeModule::class,
    'importer' => \Aqualuxe\Modules\Importer\ImporterModule::class,
    'i18n' => \Aqualuxe\Modules\I18n\MultilingualModule::class,
    ];
