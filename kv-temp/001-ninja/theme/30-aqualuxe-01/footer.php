...
?>
	...
	<footer id="colophon" class="site-footer bg-dark-800 text-white py-12" role="contentinfo">
		<div class="container mx-auto px-4">
					...
					<?php else : ?>
						<div class="footer-branding">
							<?php if ( has_custom_logo() ) : ?>
								<?php the_custom_logo(); ?>
							<?php else : ?>
								<h2 class="text-2xl font-serif font-bold text-white mb-4"><?php bloginfo( 'name' ); ?></h2>
							<?php endif; ?>
					...
					<?php else : ?>
						...
						<ul class="space-y-4">
							<li class="flex items-start">
								<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-primary-400 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
							...
							<li class="flex items-start">
								...
								<a href="mailto:info@aqualuxe.example.com" class="text-dark-200 hover:text-primary-400 transition-colors duration-200">info@aqualuxe.example.com</a>
							</li>
							<li class="flex items-start">
								<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-primary-400 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
			...
			<div class="border-t border-dark-700 mt-8 pt-8">
				<div class="flex flex-col md:flex-row justify-between items-center">
					<div class="footer-copyright text-dark-300 text-sm mb-4 md:mb-0">
						<?php
		...
		<!-- Back to top button -->
		<button class="back-to-top fixed bottom-8 right-8 bg-primary-600 text-white p-2 rounded-full shadow-lg opacity-0 invisible transition-all duration-300" aria-label="<?php esc_attr_e( 'Back to top', 'aqualuxe' ); ?>">
