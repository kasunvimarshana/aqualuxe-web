...
<head>
  ...
  <nav class="primary-nav flex items-center gap-4" aria-label="Primary">
        ...
        <div class="flex items-center gap-4">
          <?php echo function_exists('do_shortcode') ? call_user_func('do_shortcode','[aqualuxe_language_switcher]') : ''; ?>
          <?php echo function_exists('do_shortcode') ? call_user_func('do_shortcode','[aqualuxe_currency_switcher]') : ''; ?>
        </div>
