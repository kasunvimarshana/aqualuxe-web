        ...
        <div class="top-bar bg-blue-900 text-white py-2">
            <div class="container mx-auto px-4 flex justify-between items-center">
                ...
                <div class="top-right-menu flex items-center space-x-4">
                    ...
                    <?php
                    // Always show cart and account icons, but they'll have different functionality
                    // based on whether WooCommerce is active or not
                    ?>
                    <div class="account-links">
                        <a href="<?php echo esc_url(function_exists('aqualuxe_get_account_url') ? aqualuxe_get_account_url() : home_url('/')); ?>" class="text-white hover:text-blue-200">
                    ...
                    <div class="cart-link">
                        <a href="<?php echo esc_url(function_exists('aqualuxe_get_cart_url') ? aqualuxe_get_cart_url() : home_url('/')); ?>" class="text-white hover:text-blue-200 relative">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <?php if (function_exists('aqualuxe_is_woocommerce_active') && aqualuxe_is_woocommerce_active()) : ?>
                                <span class="cart-count absolute -top-2 -right-2 bg-blue-500 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center">
                                    <?php echo esc_html(function_exists('aqualuxe_get_cart_count') ? aqualuxe_get_cart_count() : '0'); ?>
                                </span>
                            <?php endif; ?>
                        </a>
                    </div>
