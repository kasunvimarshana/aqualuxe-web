...
require_once AQUALUXE_INC_DIR . '/core/logger.php';
...
require_once AQUALUXE_INC_DIR . '/core/sitemap.php';

// Flush rewrite rules on theme activation to register sitemap route.
