...
$section_title = get_theme_mod( 'aqualuxe_cta_title', __( 'Ready to Get Started?', 'aqualuxe' ) );
$section_content = get_theme_mod( 'aqualuxe_cta_content', __( 'Discover our premium products and elevate your online shopping experience today.', 'aqualuxe' ) );
$primary_button_text = get_theme_mod( 'aqualuxe_cta_primary_button_text', __( 'Shop Now', 'aqualuxe' ) );
$primary_button_url = get_theme_mod( 'aqualuxe_cta_primary_button_url', '#' );
$secondary_button_text = get_theme_mod( 'aqualuxe_cta_secondary_button_text', __( 'Learn More', 'aqualuxe' ) );
$secondary_button_url = get_theme_mod( 'aqualuxe_cta_secondary_button_url', '#' );
$background_color = get_theme_mod( 'aqualuxe_cta_background', 'primary' );
$background_image = get_theme_mod( 'aqualuxe_cta_background_image', '' );
$text_alignment = get_theme_mod( 'aqualuxe_cta_text_alignment', 'center' );
