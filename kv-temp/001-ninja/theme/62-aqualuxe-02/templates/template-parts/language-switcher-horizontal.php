<?php
/**
 * Template part for displaying horizontal language switcher
 *
 * @package AquaLuxe
 * @since 1.0.0
 */
...
<div class="aqualuxe-language-switcher aqualuxe-language-switcher--horizontal aqualuxe-language-switcher--<?php echo esc_attr( $args['location'] ); ?>">
    <ul class="aqualuxe-language-switcher__list aqualuxe-language-switcher__list--horizontal">
