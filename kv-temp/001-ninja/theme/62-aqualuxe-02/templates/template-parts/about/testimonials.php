...
$section_title = get_theme_mod( 'aqualuxe_about_testimonials_title', __( 'What Our Customers Say', 'aqualuxe' ) );
$section_subtitle = get_theme_mod( 'aqualuxe_about_testimonials_subtitle', __( 'Read testimonials from our satisfied customers', 'aqualuxe' ) );
$layout_style = get_theme_mod( 'aqualuxe_about_testimonials_layout', 'slider' );
$background_color = get_theme_mod( 'aqualuxe_about_testimonials_background', 'light' );
...
$default_testimonials = array(
    ...
    array(
        ...
        'content'  => 'As a small business owner, I needed a theme that was easy to use but still professional. AquaLuxe exceeded my expectations in every way.',
        'rating'   => 5,
...
$testimonials = array();
for ( $i = 1; $i <= 4; $i++ ) {
    $testimonial_name = get_theme_mod( 'aqualuxe_about_testimonial_' . $i . '_name', $default_testimonials[$i-1]['name'] );
    $testimonial_position = get_theme_mod( 'aqualuxe_about_testimonial_' . $i . '_position', $default_testimonials[$i-1]['position'] );
    $testimonial_content = get_theme_mod( 'aqualuxe_about_testimonial_' . $i . '_content', $default_testimonials[$i-1]['content'] );
    $testimonial_rating = get_theme_mod( 'aqualuxe_about_testimonial_' . $i . '_rating', $default_testimonials[$i-1]['rating'] );
    $testimonial_image = get_theme_mod( 'aqualuxe_about_testimonial_' . $i . '_image', $default_testimonials[$i-1]['image'] );
