...
/**
 * Display post thumbnail with enhanced functionality
 */
    ...
    if (is_singular()) :
        ...
        <div class="post-thumbnail">
            <a class="post-thumbnail-link" href="<?php the_permalink(); ?>" aria-hidden="true" tabindex="-1">
                <?php the_post_thumbnail('aqualuxe-thumbnail', array('class' => 'w-full h-auto rounded-lg shadow-md hover:shadow-lg transition-shadow')); ?>
            </a>
        </div><!-- .post-thumbnail -->
        <?php
