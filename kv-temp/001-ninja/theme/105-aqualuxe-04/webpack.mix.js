...
mix.js('assets/src/js/modules/dark-mode.js', 'assets/dist/js/modules')
   ...
   .js('assets/src/js/modules/subscriptions.js', 'assets/dist/js/modules')
   .js('assets/src/js/modules/affiliate.js', 'assets/dist/js/modules')
   .js('assets/src/js/modules/research-development.js', 'assets/dist/js/modules')
   .js('assets/src/js/modules/multi-currency.js', 'assets/dist/js/modules');
