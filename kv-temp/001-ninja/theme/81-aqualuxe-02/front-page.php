...
<section class="relative overflow-hidden" aria-label="Hero">
  ...
  <a href="<?php echo esc_url( (aqualuxe_is_woocommerce_active() && function_exists('wc_get_page_id')) ? get_permalink(call_user_func('wc_get_page_id','shop')) : home_url('/blog/') ); ?>" class="bg-cyan-600 text-white px-6 py-3 rounded shadow hover:bg-cyan-700 transition">Shop Now</a>
