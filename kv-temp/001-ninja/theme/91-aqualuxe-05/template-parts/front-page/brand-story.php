...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4 flex flex-wrap items-center">
        <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0">
            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/brand-story.jpg' ); ?>" alt="<?php esc_attr_e( 'Our Brand Story', 'aqualuxe' ); ?>" class="rounded-lg shadow-lg">
        </div>
