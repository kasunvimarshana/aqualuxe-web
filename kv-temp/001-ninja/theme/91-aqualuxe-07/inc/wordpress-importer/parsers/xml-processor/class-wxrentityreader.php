 ...
 *
 * * Speed â€“ it should be as fast as possible
 * * No PHP extensions required â€“ it can run on any PHP installation
 * * Reliability â€“ no random crashes when encountering malformed XML or UTF-8 sequences
 ...
 * make the API consumption easier with its transformationâ€“oriented API for chaining data processors.
 *
 ...
 * * Do multiple passes over the WXR file â€“ one for each level of nesting, e.g. 1. Insert posts, 2. Insert Comments, 3. Insert comment meta
 *
 * Buffering all the post meta and comments seems like a bad idea â€“ there might be gigabytes of data.
 *
 * ## Remaining work
 *
 * @TODO:
...
class WXREntityReader implements EntityReader {
	...
	private function read_next_entity() {
		...
		do {
			 ...
			 *
			 * * Empty elements â€“ such as <wp:comment_content />, that we'll ignore
