...
## Shortcodes
- [aqualuxe_currency_switcher] – Header-ready currency dropdown; integrates with Multicurrency module.
- [aqualuxe_language_switcher] – Language links if Polylang/WPML present; locale badge fallback.
