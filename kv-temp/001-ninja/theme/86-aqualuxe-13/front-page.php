...
<main id="primary" class="site-main" role="main">
  ...
  <section class="testimonials bg-slate-50 dark:bg-slate-900/40 py-16" aria-labelledby="testimonials-heading">
    <div class="container mx-auto px-4">
      <h2 id="testimonials-heading" class="text-2xl font-semibold mb-6"><?php esc_html_e('What our clients say', 'aqualuxe'); ?></h2>
      <?php echo function_exists('do_shortcode') ? do_shortcode('[aqualuxe_testimonials count="6"]') : ''; ?>
    </div>
  </section>
