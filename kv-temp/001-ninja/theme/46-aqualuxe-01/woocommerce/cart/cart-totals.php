...
?>
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?> bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">

	<?php do_action( 'woocommerce_before_cart_totals' ); ?>

	<h2 class="text-xl font-bold mb-4"><?php esc_html_e( 'Cart totals', 'aqualuxe' ); ?></h2>
