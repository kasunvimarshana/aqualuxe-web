...
?>
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?> bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">

    <?php do_action( 'woocommerce_before_cart_totals' ); ?>

    <h2 class="text-2xl font-bold mb-6 text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-4"><?php esc_html_e( 'Cart totals', 'aqualuxe' ); ?></h2>
    ...
    <div class="shop_table shop_table_responsive">
        <div class="cart-subtotal flex justify-between py-3 border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="text-gray-900 dark:text-gray-100 font-medium" data-title="<?php esc_attr_e( 'Subtotal', 'aqualuxe' ); ?>">
        ...
        <?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
            <div class="cart-discount coupon-<?php echo esc_attr( sanitize_title( $code ) ); ?> flex justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="text-green-600 dark:text-green-400" data-title="<?php echo esc_attr( wc_cart_totals_coupon_label( $coupon, false ) ); ?>">
        ...
        <?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
            <div class="shipping-section py-3 border-b border-gray-200 dark:border-gray-700">
                <div class="text-gray-700 dark:text-gray-300"><?php esc_html_e( 'Shipping', 'aqualuxe' ); ?></div>
                <div data-title="<?php esc_attr_e( 'Shipping', 'aqualuxe' ); ?>">
        ...
        <?php foreach ( WC()->cart->get_fees() as $fee ) : ?>
            <div class="fee flex justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="text-gray-900 dark:text-gray-100" data-title="<?php echo esc_attr( $fee->name ); ?>">
            ...
            if ( 'itemized' === get_option( 'woocommerce_tax_total_display' ) ) {
                foreach ( WC()->cart->get_tax_totals() as $code => $tax ) {
                    ...
                    <div class="tax-rate tax-rate-<?php echo esc_attr( sanitize_title( $code ) ); ?> flex justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                        <div class="text-gray-700 dark:text-gray-300"><?php echo esc_html( $tax->label ) . $estimated_text; ?></div>
                        <div class="text-gray-900 dark:text-gray-100" data-title="<?php echo esc_attr( $tax->label ); ?>">
                ...
                <div class="tax-total flex justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                    <div class="text-gray-700 dark:text-gray-300"><?php echo esc_html( WC()->countries->tax_or_vat() ) . $estimated_text; ?></div>
                    <div class="text-gray-900 dark:text-gray-100" data-title="<?php echo esc_attr( WC()->countries->tax_or_vat() ); ?>">
        ...
        <div class="order-total flex justify-between py-4 mt-2">
            ...
            <div class="text-xl font-bold text-primary-600 dark:text-primary-400" data-title="<?php esc_attr_e( 'Total', 'aqualuxe' ); ?>">
