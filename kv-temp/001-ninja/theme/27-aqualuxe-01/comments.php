...
<div id="comments" class="comments-area mt-12 pt-8 border-t border-gray-200">
    ...
    comment_form(
        array(
            ...
            'class_submit'       => 'submit bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded transition-colors',
            'comment_field'      => '<div class="comment-form-comment mb-4"><label for="comment" class="block mb-2">' . _x( 'Comment', 'noun', 'aqualuxe' ) . '</label><textarea id="comment" name="comment" class="w-full p-2 border border-gray-300 rounded" rows="8" maxlength="65525" required="required"></textarea></div>',
        )
    );
    ?>
