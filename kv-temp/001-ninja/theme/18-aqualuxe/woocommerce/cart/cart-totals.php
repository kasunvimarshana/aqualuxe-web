...
?>
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?> bg-gray-50 dark:bg-gray-800 rounded-xl p-6">

    <?php do_action('woocommerce_before_cart_totals'); ?>

    <h2 class="text-2xl font-bold mb-6"><?php esc_html_e('Cart totals', 'aqualuxe'); ?></h2>
    ...
    <div class="shop_table shop_table_responsive">
        ...
        <div class="cart-subtotal flex justify-between py-3 border-b border-gray-200 dark:border-gray-700">
            <div class="font-medium"><?php esc_html_e('Subtotal', 'aqualuxe'); ?></div>
            <div data-title="<?php esc_attr_e('Subtotal', 'aqualuxe'); ?>"><?php wc_cart_totals_subtotal_html(); ?></div>
        </div>
        ...
        <?php elseif (WC()->cart->needs_shipping() && 'yes' === get_option('woocommerce_enable_shipping_calc')) : ?>
            ...
            <div class="shipping flex justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                <div><?php esc_html_e('Shipping', 'aqualuxe'); ?></div>
        ...
        <div class="order-total flex justify-between py-3 border-b border-gray-200 dark:border-gray-700 text-lg font-bold">
            <div><?php esc_html_e('Total', 'aqualuxe'); ?></div>
            <div data-title="<?php esc_attr_e('Total', 'aqualuxe'); ?>"><?php wc_cart_totals_order_total_html(); ?></div>
        </div>
