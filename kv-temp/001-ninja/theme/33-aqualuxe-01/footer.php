...
?>
	...
	<footer id="colophon" class="site-footer bg-dark-900 text-white py-12" role="contentinfo">
		<div class="container mx-auto px-4">
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
				...
				<div class="footer-widget">
					...
					<?php else : ?>
						<h3 class="text-lg font-bold mb-4 text-white"><?php esc_html_e( 'Quick Links', 'aqualuxe' ); ?></h3>
						<?php
						wp_nav_menu(
							array(
				...
				<div class="footer-widget">
					...
					<?php else : ?>
						<h3 class="text-lg font-bold mb-4 text-white"><?php esc_html_e( 'Contact Us', 'aqualuxe' ); ?></h3>
				...
				<div class="footer-widget">
					...
					<?php else : ?>
						<h3 class="text-lg font-bold mb-4 text-white"><?php esc_html_e( 'Newsletter', 'aqualuxe' ); ?></h3>
...
<?php if ( function_exists( 'aqualuxe_back_to_top' ) ) : ?>
