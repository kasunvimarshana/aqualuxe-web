...
class Customizer extends Service {
	...
	private function register_sections( $wp_customize ) {
		...
		$social_media = new Sections\Social_Media( $wp_customize );
		...
		$wp_customize->add_section(
			new Sections\Pro_Section(
				...
				array(
					...
					'pro_url'     => 'https://example.com/aqualuxe-pro',
					'priority'    => 0,
				)
			)
		);
	...
	public function generate_custom_css() {
		...
		// Colors.
		$primary_color = $this->get_theme_option( 'aqualuxe_primary_color', '#0ea5e9' );
		$secondary_color = $this->get_theme_option( 'aqualuxe_secondary_color', '#14b8a6' );
		$accent_color = $this->get_theme_option( 'aqualuxe_accent_color', '#f97316' );
		$text_color = $this->get_theme_option( 'aqualuxe_text_color', '#374151' );
		$heading_color = $this->get_theme_option( 'aqualuxe_heading_color', '#1f2937' );
		$link_color = $this->get_theme_option( 'aqualuxe_link_color', '#0ea5e9' );
		$link_hover_color = $this->get_theme_option( 'aqualuxe_link_hover_color', '#0369a1' );
		$background_color = $this->get_theme_option( 'aqualuxe_background_color', '#ffffff' );
		
		// Typography.
		$body_font_family = $this->get_theme_option( 'aqualuxe_body_font_family', 'Inter' );
		$body_font_size = $this->get_theme_option( 'aqualuxe_body_font_size', '16px' );
		$body_line_height = $this->get_theme_option( 'aqualuxe_body_line_height', '1.6' );
		$heading_font_family = $this->get_theme_option( 'aqualuxe_heading_font_family', 'Playfair Display' );
		
		// Layout.
		$container_width = $this->get_theme_option( 'aqualuxe_container_width', '1200px' );
		$sidebar_width = $this->get_theme_option( 'aqualuxe_sidebar_width', '300px' );
		
		// Header.
		$header_background = $this->get_theme_option( 'aqualuxe_header_background', '#ffffff' );
		$header_text_color = $this->get_theme_option( 'aqualuxe_header_text_color', '#374151' );
		
		// Footer.
		$footer_background = $this->get_theme_option( 'aqualuxe_footer_background', '#1f2937' );
		$footer_text_color = $this->get_theme_option( 'aqualuxe_footer_text_color', '#f3f4f6' );
		...
		// Dark mode colors.
		$dark_primary_color = $this->get_theme_option( 'aqualuxe_dark_primary_color', '#38bdf8' );
		$dark_secondary_color = $this->get_theme_option( 'aqualuxe_dark_secondary_color', '#2dd4bf' );
		$dark_accent_color = $this->get_theme_option( 'aqualuxe_dark_accent_color', '#fb923c' );
		$dark_text_color = $this->get_theme_option( 'aqualuxe_dark_text_color', '#f3f4f6' );
		$dark_heading_color = $this->get_theme_option( 'aqualuxe_dark_heading_color', '#f9fafb' );
		$dark_link_color = $this->get_theme_option( 'aqualuxe_dark_link_color', '#38bdf8' );
		$dark_link_hover_color = $this->get_theme_option( 'aqualuxe_dark_link_hover_color', '#7dd3fc' );
		$dark_background_color = $this->get_theme_option( 'aqualuxe_dark_background_color', '#111827' );
		...
		$css .= '--header-background: ' . $this->get_theme_option( 'aqualuxe_dark_header_background', '#111827' ) . ';';
		$css .= '--header-text-color: ' . $this->get_theme_option( 'aqualuxe_dark_header_text_color', '#f3f4f6' ) . ';';
		$css .= '--footer-background: ' . $this->get_theme_option( 'aqualuxe_dark_footer_background', '#0f172a' ) . ';';
		$css .= '--footer-text-color: ' . $this->get_theme_option( 'aqualuxe_dark_footer_text_color', '#f3f4f6' ) . ';';
		$css .= '}';
		...
		// Add custom CSS.
		$custom_css = $this->get_theme_option( 'aqualuxe_custom_css' );
		if ( $custom_css ) {
			$css .= $custom_css;
		}
