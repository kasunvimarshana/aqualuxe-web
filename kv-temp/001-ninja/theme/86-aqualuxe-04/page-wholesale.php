...
<main id="primary" class="container mx-auto px-4 py-10">
  ...
  <section class="mb-12">
  <h2 class="text-2xl font-semibold mb-4"><?php echo function_exists('esc_html__') ? call_user_func('esc_html__', 'Apply for a Wholesale Account', 'aqualuxe') : 'Apply for a Wholesale Account'; ?></h2>
  ...
  <section class="mt-12">
  <h2 class="text-2xl font-semibold mb-4"><?php echo function_exists('esc_html__') ? call_user_func('esc_html__', 'Featured Products', 'aqualuxe') : 'Featured Products'; ?></h2>
