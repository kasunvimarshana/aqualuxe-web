...
<?php if ( ! empty( $this->authors ) ) : ?>
	...
	<p><?php _e( 'To make it simpler for you to edit and save the imported content, you may want to reassign the author of the imported item to an existing user of this site. For example, you may want to import all the entries as <code>admin</code>s entries.', 'wordpress-importer' ); ?></p>
...
<?php
	...
	function author_select( $n, $author ) {
		...
		if ( $create_users ) {
			echo '<label for="user_new_'.(int)$n.'">';
			if ( $this->version != '1.0' ) {
			...
			echo ' <input type="text" id="user_new_'.(int)$n.'" name="user_new['.$n.']" value="'. $value .'" /><br />';
		}

		echo '<label for="imported_authors_'.(int)$n.'">';
		...
		echo ' ' . wp_dropdown_users( array( 'name' => "user_map[$n]", 'id' => 'imported_authors_'.(int)$n, 'multi' => true, 'show_option_all' => __( '- Select -', 'wordpress-importer' ), 'show' => 'display_name_with_login', 'echo' => 0 ) );
