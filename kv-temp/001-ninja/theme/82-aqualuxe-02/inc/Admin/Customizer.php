...
class Customizer {
	public static function register( $wp_customize ) : void {
		...
		// Hero SFX (bubble pops)
		$wp_customize->add_setting( 'aqualuxe_enable_hero_sfx', [
			'default' => 1,
			'sanitize_callback' => 'absint',
		] );
		$wp_customize->add_control( 'aqualuxe_enable_hero_sfx', [
			'label' => ( function_exists('__') ? call_user_func('__', 'Enable hero sound effects (bubbles)', 'aqualuxe' ) : 'Enable hero sound effects (bubbles)' ),
