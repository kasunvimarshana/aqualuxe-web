...
<main id="primary" class="site-main container mx-auto px-4 py-10">
	...
	<article <?php if ( function_exists('post_class') ) { call_user_func('post_class','prose max-w-3xl mx-auto'); } else { echo 'class="prose max-w-3xl mx-auto"'; } ?> itemscope itemtype="https://schema.org/Event">
