...
<div class="cart-container">
                            ...
                            <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                                ...
                                <td class="product-remove">
                                    ...
                                    echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                        ...
                                        sprintf(
                                            '<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s" data-cart-item-key="%s">&times;</a>',
    ...
    <div class="cart-collaterals">
        <?php
        /**
         * Hook: aqualuxe_before_cart_collaterals.
         */
        do_action( 'aqualuxe_before_cart_collaterals' );
        ...
        /**
         * Hook: aqualuxe_after_cart_collaterals.
         */
        do_action( 'aqualuxe_after_cart_collaterals' );
        ?>
    </div>
</div>
