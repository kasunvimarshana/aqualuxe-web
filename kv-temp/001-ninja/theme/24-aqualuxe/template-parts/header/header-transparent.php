...
<header id="masthead" class="site-header absolute w-full bg-transparent <?php echo esc_attr( $header_class ); ?>">
            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="site-branding flex items-center">
                    ...
                    if ( has_custom_logo() ) :
                        ...
                        // Check if there's a white logo version for transparent header
                        $white_logo_url = get_theme_mod( 'aqualuxe_white_logo' );
                        
                        if ( $white_logo_url ) {
                            echo '<a href="' . esc_url( home_url( '/' ) ) . '" class="custom-logo-link" rel="home">';
                            echo '<img src="' . esc_url( $white_logo_url ) . '" class="custom-logo" alt="' . esc_attr( get_bloginfo( 'name' ) ) . '">';
                            echo '</a>';
                        } else {
                            the_custom_logo();
                        }
                        ...
                        if ( $aqualuxe_description || is_customize_preview() ) :
                            ?>
                            <p class="site-description ml-2 text-sm text-gray-200">
                ...
                <nav id="site-navigation" class="main-navigation hidden lg:block">
                    ...
                    wp_nav_menu(
                        array(
                            ...
                            'container'      => false,
                            'fallback_cb'    => false,
                            'link_class'     => 'hover:text-primary-light transition-colors',
                        )
                    );
                    ?>
                </nav><!-- #site-navigation -->
                ...
                <div class="header-actions flex items-center space-x-4">
                    <?php if ( function_exists( 'aqualuxe_get_theme_mode_toggle' ) ) : ?>
                        <div class="theme-mode-toggle text-white">
                    ...
                    <?php if ( class_exists( 'WooCommerce' ) ) : ?>
                        <div class="search-toggle">
                            <button id="header-search-toggle" class="text-white hover:text-primary-light transition-colors">
                        ...
                        <?php if ( get_theme_mod( 'aqualuxe_enable_wishlist', true ) ) : ?>
                            <div class="wishlist-link">
                                <a href="<?php echo esc_url( wc_get_endpoint_url( 'wishlist', '', wc_get_page_permalink( 'myaccount' ) ) ); ?>" class="relative flex items-center text-white hover:text-primary-light transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="cart-link">
                            <a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="relative flex items-center text-white hover:text-primary-light transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="mobile-menu-toggle lg:hidden">
                        <button id="mobile-menu-toggle" class="text-white hover:text-primary-light transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
