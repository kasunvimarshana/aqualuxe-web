...
class AquaLuxe_Events_Module {
    ...
    public function event_tickets_meta_box($post) {
        ...
        <table class="form-table">
            ...
            <tr class="ticket-price-row" style="<?php echo $is_free ? 'display: none;' : ''; ?>">
    ...
    public function event_location_meta_box($post) {
        ...
        <table class="form-table">
            ...
            <tr class="physical-location" style="<?php echo in_array($location_type, array('physical', 'hybrid')) ? '' : 'display: none;'; ?>">
            ...
            <tr class="online-location" style="<?php echo in_array($location_type, array('online', 'hybrid')) ? '' : 'display: none;'; ?>">
