...
(function($) {
  ...
  const aqualuxe = {
    ...
    isWooCommerceActive: function() {
      return typeof aqualuxeData !== 'undefined' && aqualuxeData.isWooCommerceActive === 'yes';
    },
    ...
    ajaxFilters: function() {
      ...
      $('.post-filters').on('submit', function(e) {
        ...
        $.ajax({
          ...
          type: 'POST',
          data: formData + '&action=aqualuxe_filter_posts&nonce=' + aqualuxeData.nonce,
      ...
      if (self.isWooCommerceActive()) {
        $('.product-filters').on('submit', function(e) {
          ...
          $.ajax({
            url: aqualuxeData.ajaxUrl,
            type: 'POST',
            data: formData + '&action=aqualuxe_filter_products&nonce=' + aqualuxeData.nonce,
            success: function(response) {
