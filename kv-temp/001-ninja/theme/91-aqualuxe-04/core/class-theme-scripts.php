...
class Theme_Scripts {
	...
	public function enqueue_styles(): void {
		...
		\wp_enqueue_style( 'aqualuxe-style', AQUALUXE_THEME_URI . 'assets/dist' . $css_path, [], AQUALUXE_VERSION );
	}
	...
	public function enqueue_scripts(): void {
		...
		\wp_enqueue_script( 'aqualuxe-script', AQUALUXE_THEME_URI . 'assets/dist' . $js_path, [ 'jquery' ], AQUALUXE_VERSION, true );
