...
class AquaLuxe_Theme {
	...
	private function load_dependencies() {
        ...
        /**
         * Load multivendor module
         */
        require_once AQUALUXE_THEME_DIR . '/inc/modules/multivendor/multivendor.php';

        /**
         * Load bookings module
         */
        require_once AQUALUXE_THEME_DIR . '/inc/modules/bookings/bookings.php';

        /**
         * The class responsible for auctions.
         */
        require_once AQUALUXE_THEME_DIR . '/inc/modules/auctions/auctions.php';

        /**
         * The class responsible for subscriptions.
         */
        require_once AQUALUXE_THEME_DIR . '/inc/modules/subscriptions/subscriptions.php';

        /**
         * The class responsible for events.
         */
        require_once AQUALUXE_THEME_DIR . '/inc/modules/events/events.php';
