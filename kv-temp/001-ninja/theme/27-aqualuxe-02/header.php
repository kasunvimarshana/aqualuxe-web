            ...
            <div class="container mx-auto px-4 flex justify-between items-center">
                ...
                <div class="top-right-menu flex items-center space-x-4">
                    ...
                    <div class="account-links">
                        <a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>" class="text-white hover:text-blue-200">
                    ...
                    <div class="cart-link">
                        <a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="text-white hover:text-blue-200 relative">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
