 ...
 * 
 * Handles call to action functionality including video backgrounds and animations
 */

const CallToAction = {
    /**
     * Initialize the call to action module
     */
    init() {
     ...
     */
    setupYouTubeVideos() {
        const youtubeVideos = document.querySelectorAll('.call-to-action__youtube-video');
    ...
    /**
     * Setup animations for call to action elements
     */
    setupAnimations() {
        const ctaSections = document.querySelectorAll('.call-to-action');
    ...
    resizeVideoBackgrounds() {
        const videos = document.querySelectorAll('.call-to-action__video');
        ...
        videos.forEach(video => {
            const container = video.closest('.call-to-action__video-container');
...
// Initialize the call to action module when the DOM is ready
document.addEventListener('DOMContentLoaded', () => {
    CallToAction.init();
    
    // Resize video backgrounds on window resize
    window.addEventListener('resize', () => {
        CallToAction.resizeVideoBackgrounds();
    });
