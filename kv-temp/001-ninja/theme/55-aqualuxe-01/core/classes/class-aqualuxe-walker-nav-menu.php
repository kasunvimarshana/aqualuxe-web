 ...
 *
 * This class extends the WordPress Walker_Nav_Menu class to add custom markup to the navigation menu.
 *
 * @package AquaLuxe
 */
...
class AquaLuxe_Walker_Nav_Menu extends Walker_Nav_Menu {
    ...
    public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
        ...
        if (in_array('menu-item-has-children', $classes)) {
            $item_output .= '<button class="dropdown-toggle" aria-expanded="false" aria-label="' . esc_attr__('Toggle dropdown menu', 'aqualuxe') . '">';
            $item_output .= aqualuxe_get_icon('chevron-down');
            $item_output .= '<span class="screen-reader-text">' . esc_html__('Toggle dropdown menu', 'aqualuxe') . '</span>';
            $item_output .= '</button>';
        }
